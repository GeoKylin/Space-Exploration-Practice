...
% 分别绘制三幅全球TEC地图
filename = 'igsg160508.gif';
for j=1:13
    k=355*(j-1);
    for i=0:70                 % 将数据重新整理为标准矩阵
        data(i+1,:)=[igsg160508(5*i+k+1,1:16) igsg160508(5*i+k+2,1:16) ...
            igsg160508(5*i+k+3,1:16) igsg160508(5*i+k+4,1:16) ...
            igsg160508(5*i+k+5,1:9)];        
    end
    ...
    title(['GLOBAL IONOSPHERE MAPS FOR DAY 129, 2016 - ',t,':00 UT']);
